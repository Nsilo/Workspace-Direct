      ...
      <Table striped bordered hover responsive>
        <thead>
          <tr>
            <th scope="col"></th>
            <th scope="col">
              <div class="arrow-up" onClick={handleSortingAsc}></div>First Name
            </th>
            <th scope="col">
              <div class="arrow-down" onClick={handleSortingDes}></div>Last Name
            </th>
        ...
        {filterUsers.map((employees, index) => (
          <tbody key={index}>
            <tr>
              <td>
                <img alt="" src={employees.picture.thumbnail} />
              </td>
